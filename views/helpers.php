...
function sidebarIcon(string $name): string
{
    static $paths = [
        ...
        'clean'         => '<path d="m12 3-1.9 4.1L6 9l4.1 1.9L12 15l1.9-4.1L18 9l-4.1-1.9z"/><path d="M5 3v4M3 5h4M19 17v4M17 19h4"/>',
        ...
        'attachment'    => '<path d="M21.44 11.05 12.25 20.24a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/>',
    ];
    $inner = $paths[$name] ?? '';
...
/** Human file size, e.g. "240 KB" / "3.4 MB" — mirrored in JS as formatSize(). */
